(function(){
    var app = angular.module('noteApp.TodoController', ['ngRoute', 'mgcrea.ngStrap'])
        ...
        .config(function($routeProvider){
            ...
            .when('/todo/create', {
                templateUrl: 'views/todo/todo-create.html',
                controller: 'TodoCreateController'
            })
            .when('/todo/view/:thingId', {
        ...
        .controller('TodoCreateController', function($scope, $log, $location, dataService){

                $scope.create =function(thing){
                    var promise = dataService.addParent(thing);

                    promise.then(function(response){
                        $location.path('/todo/view/'+response.data.id);
                    }, function(error){
                        $log.error(error);
                    });
