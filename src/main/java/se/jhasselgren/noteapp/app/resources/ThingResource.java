package se.jhasselgren.noteapp.app.resources;

import com.codahale.metrics.annotation.Timed;
import com.sun.jersey.core.header.FormDataContentDisposition;
import com.sun.jersey.multipart.FormDataParam;
import io.dropwizard.hibernate.UnitOfWork;
import se.jhasselgren.noteapp.app.db.FileInformationDAO;
import se.jhasselgren.noteapp.app.db.ThingDAO;
...
public class ThingResource {
    ...
    @POST
    @UnitOfWork
    public Response addParent(Thing thing){
    	ToDoThing parentThing = new ToDoThing();
    	parentThing.setName(thing.getName());
    	parentThing.setDescription(thing.getDescription());
